...
# -*- coding: utf-8 -*-
"""
脚本名称: clean_gmail_otp.py
脚本功能: 自动删除 Gmail 验证码邮件
作者: 小猩 🦧
创建日期: 2026-02-22
版本: 1.0.0
...
def check_required_env():
    ...
    if missing:
        ...
        for item in missing:
            print(f"   - {item}")
        print("\n💡 请设置环境变量 GMAIL_USER 和 GMAIL_APP_PASSWORD")
        return False
    return True
...
LOG_FILE = os.path.join(LOGS_DIR, "gmail_clean_otp.log")
...
def is_otp_email(subject, from_header, body_text):
    ...
    otp_senders = [
        ...
        'security', 'account', 'service', 'support'
    ]
...
def clean_otp_emails():
    ...
    try:
        ...
        with open(LOG_FILE, "a", encoding="utf-8") as f:
            f.write(f"[{timestamp}] Gmail验证码清理完成:\\n")
